 ...
 *=======================================================================
 * aStar
 * This library contains all the functions and objects required to run an A* search
 * algorithm.  Except where noted, it uses all of the same functions as genericSearch
 *=======================================================================
 */
 ...
 * Output (number): if the heuristic score [h(n) + g(n)] for a is less than the heuristic score for b, returns -1
 *                  if the heuristic score [h(n) + g(n)] for a is greater than the heuristic score for b, returns 1
 *                  otherwise returns 0
